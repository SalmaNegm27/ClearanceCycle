...
namespace ClearanceCycle.DataAcess.Migrations
{
    ...
    [Migration("20250222235923_init10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.Step", b =>
                {
                    ...
                    b.Property<int>("ApprovalGroupIds")
                        .HasMaxLength(300)
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.StepTransition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NextActionStepId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.StepTransition", b =>
                {
                    b.HasOne("ClearanceCycle.WorkFlow.Models.Step", "NextActionStep")
                        .WithMany()
                        .HasForeignKey("NextActionStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClearanceCycle.WorkFlow.Models.StepAction", "StepAction")
                        .WithMany("StepTransitions")
                        .HasForeignKey("StepActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NextActionStep");

                    b.Navigation("StepAction");
                });

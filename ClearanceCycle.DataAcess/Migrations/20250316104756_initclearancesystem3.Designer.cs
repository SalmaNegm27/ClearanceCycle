...
namespace ClearanceCycle.DataAcess.Migrations
{
    ...
    [Migration("20250316104756_initclearancesystem3")]
    partial class initclearancesystem3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClearanceCycle.Domain.Entities.ClearanceRequest", b =>
                {
                    ...
                    b.Property<bool>("IsResigneeAccountsClosed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ClearanceCycle.Domain.Entities.EscalationPointEmployee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ApprovalGroupEmployeeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApprovalGroupEmployeeId");

                    b.ToTable("EscalationPointEmployees");
                });
            ...
            modelBuilder.Entity("ClearanceCycle.Domain.Entities.StepApprovalAssignments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StepApprovalAssignments");
                });
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.Action", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.Cycle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.Step", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ApprovalGroupIds")
                        .IsRequired()
                        .HasMaxLength(300)
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.StepAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClearanceCycle.Domain.Entities.EscalationPointEmployee", b =>
                {
                    b.HasOne("ClearanceCycle.Domain.Entities.ApprovalGroupEmployee", "ApprovalGroupEmployee")
                        .WithMany("EscalationPointEmployees")
                        .HasForeignKey("ApprovalGroupEmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApprovalGroupEmployee");
                });
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.Step", b =>
                {
                    b.HasOne("ClearanceCycle.WorkFlow.Models.Cycle", "Cycle")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("ClearanceCycle.WorkFlow.Models.StepAction", b =>
                {
                    b.HasOne("ClearanceCycle.WorkFlow.Models.Action", "Action")
                        .WithMany("StepActions")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClearanceCycle.WorkFlow.Models.Step", "CurrentStep")
                        .WithMany("StepActions")
            ...
            modelBuilder.Entity("ClearanceCycle.Domain.Entities.ApprovalGroupEmployee", b =>
                {
                    b.Navigation("EscalationPointEmployees");
                });

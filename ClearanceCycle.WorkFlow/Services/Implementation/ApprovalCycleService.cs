...
namespace ClearanceCycle.WorkFlow.Services.Implementation
{
    public class ApprovalCycleService : IApprovalCycleService
    {
        ...
        public ApprovalCycleService(IGenericRepository<Cycle> cycleRepo, IGenericRepository<Step> stepRepo, IMapper mapper)
        {
